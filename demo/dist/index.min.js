...
Demo.FontList = function (element, options) {
    return {
        ...
        _initButton: function _initButton(element) {
        ...
        _selectFont: function _selectFont(name) {
        ...
        _getButton: function _getButton(name) {
...
Demo.StyleSheet = function (element, options) {
    ...
    return {
        ...
        _removeStylesheet: function _removeStylesheet(element) {
